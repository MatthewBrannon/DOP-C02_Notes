...
- **Configuration Compliance**
    ...
    - View compliance history and change tracking for Patch Manager patching data and State Manager associations by using [AWS Config](https://tutorialsdojo.com/aws-config/).
